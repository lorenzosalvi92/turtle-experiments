...
for pi, we draw follow (turn 3, turn 1, turn 4, turn 1, turn 5, turn 9, etc...) where between each turn you move forward 1 step, and 'turn 1' means 'turn 1 tenth of 360°'.
